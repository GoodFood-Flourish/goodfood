...
<head>
  ...
  <title>Good Food Jakarta | Home </title>
</head>
...
<body>
  ...
  <header class="fixed-top">
    <div class="container">
      <nav class="py-5">
        <div
          class="humberger-menu rounded-circle h-40 w-40 bg-white d-flex justify-content-center align-items-center opacity-75 mb-3 shadow">
        ...
        <div
          class="profile rounded-circle h-40 w-40 bg-white d-flex justify-content-center align-items-center opacity-75 shadow">
          ...
          <div class="food-list-content">
            ...
            <div class="col-md-10 food-list-content-title">
              <p>Lorem ipsum dolor sit amet, cons ectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
                ...
                accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit. Ut wisi enim ad minim
                veniam, quis
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9  p-5">
              <p class="col-md-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur praesentium
                possimus voluptate
              ...
              <p class="col-md-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat iure iusto labore
                quisquam, vero atque
  ...
  <footer class="bg-main-purple py-5 mt-10">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="">
            <img src="../images/good-footer-logo.svg" alt="good food logo">
          </div>
        </div>
        <div class="col-lg-3">
          <ul class="list-unstyled">
            <li>
              <a href="#" class="text-uppercase text-white">About</a>
            </li>
            <li>
              <a href="#" class="text-uppercase text-white">Good Food Everyday</a>
            </li>
            <li>
              <a href="#" class="text-uppercase text-white">Good Food Catering</a>
            </li>
            <li>
              <a href="#" class="text-uppercase text-white">Cuisines</a>
            </li>
            <li>
