                ...
                <div class="food-list-content">
                    ...
                    <div class="col-md-10 food-list-content-title">
                        <p>Lorem ipsum dolor sit amet, cons ectetuer adipiscing elit, sed diam nonummy nibh euismod
                            ...
                            accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit. Ut wisi enim ad
                            minim veniam, quis
                            nostrud exerci tation ullamcorper suscipit.</p>
                        <br>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                            ut
                            laoreet dolore magna aliquam erat volutpat. Duis autem vel eum iriure dolor in lorem ipsum dolor
                            sit
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9  p-5">
                        <p class="col-md-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur
                            praesentium possimus voluptate
                            voluptatem iste est quae quibusdam? Fugiat, atque, aspernatur aperiam provident alias, error
                            eveniet
                            architecto placeat praesentium modi nihil!</p>
                        <p class="col-md-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat iure
                            iusto labore quisquam, vero atque
                            nam quos libero vel architecto, accusamus in nesciunt ex perspiciatis a nemo et autem sapiente
                            non
                            voluptatum quibusdam ullam repudiandae. Veritatis molestiae consequuntur saepe quae neque, earum
                            porro
                                            ...
                                            <div class="card">
                                                ...
                                                <a href="#">
                                                    <img class="img-fluid" alt="100%x280"
                                                        src="../images/indonesia_thumb.png">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
            ...
            <div id="carouselContent" class="carousel slide" data-ride="carousel" style="background-color: #E8E3E6;">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active text-center p-4">
                        <p class="col-md-12">Lorem ipsum dolor sit amet, cons ectetuer adipiscing elit, sed diam
                            nonummy nibh euismod tincidunt ut
                            laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci
                            tation
                            ullamcorper suscipit lobortis nisl ut illum dolore eu feugiat nulla facilisis at vero eroswisi
                            enim ad minim
                            veniam, quis nostrud Ssed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam
                            erat
                            volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci elit, sed diam nonummy nibh euismod
                        </p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group my-5">
                                    <input type="text" class="form-control" placeholder="Name" aria-label="Name" name=""
                                        id="" />
                                </div>
                                <div class="form-group my-5">
                                    <input type="email" class="form-control" placeholder="Email Address"
                                        aria-label="name@example.com" name="" id="" />
                                </div>
